...
final class CLIWrapperResourceTests: XCTestCase {
    ...
    func testBundledCLIWrapperUsesGeName() {
        let geWrapper = resourcesDirectory.appendingPathComponent("bin/ge")
        let geulWrapper = resourcesDirectory.appendingPathComponent("bin/geul")
        let glWrapper = resourcesDirectory.appendingPathComponent("bin/gl")
    ...
    func testCLIWrapperReportsInvokedCommandNameAndSupportedInstallPaths() throws {
        let wrapper = resourcesDirectory.appendingPathComponent("bin/ge")
        ...
        XCTAssertTrue(content.contains("Contents/Resources/Resources/bin"))
