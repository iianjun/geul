...
install: build-xcode
	...
	APP="$$BUILT/geul.app"; \
	WRAPPER="$$APP/Contents/Resources/Resources/bin/ge"; \
	...
	for link in "$$PRIMARY" "$$FALLBACK"; do \
	  if [ -L "$$link" ]; then \
	    ...
	    case "$$TARGET" in \
	      "$$APP/Contents/Resources/Resources/bin/ge"|"$$APP/Contents/Resources/Resources/bin/geul"|"$$APP/Contents/Resources/Resources/bin/gl"|\
	      "$$APP/Contents/Resources/Resources/ge"|"$$APP/Contents/Resources/Resources/geul"|"$$APP/Contents/Resources/Resources/gl"|\
	      "$$HOME/Library/Developer/Xcode/DerivedData/geul-"*/Build/Products/Debug/geul.app/Contents/Resources/Resources/bin/ge|\
	      "$$HOME/Library/Developer/Xcode/DerivedData/geul-"*/Build/Products/Debug/geul.app/Contents/Resources/Resources/bin/geul|\
	      "$$HOME/Library/Developer/Xcode/DerivedData/geul-"*/Build/Products/Debug/geul.app/Contents/Resources/Resources/bin/gl|\
